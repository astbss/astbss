...
# docker build -f Dockerfile.python3.7.5 -t astbss/python:3.7.5 .
# docker tag astbss/python:3.7.5 astbss/python:latest
# docker push astbss/python:3.7.5 ; docker push astbss/python:latest
# docker run -it --rm astbss/python:3.7.5 bash
# docker run -v /app/my-app:/app -it  --rm --entrypoint "/bin/bash" astbss/python:3.7.5
# docker run -v /home/are:/app -it --rm astbss/python:3.7.5 bash
