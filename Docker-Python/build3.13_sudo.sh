...
# wget -O build3.13_sudo.sh https://raw.githubusercontent.com/astbss/astbss/refs/heads/master/Docker-Python/build3.13_sudo.sh
# wget -O build3.13.sh https://raw.githubusercontent.com/astbss/astbss/refs/heads/master/Docker-Python/build3.13.sh
